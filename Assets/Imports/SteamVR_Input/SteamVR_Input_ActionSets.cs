...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_PriTaskController p_PriTaskController;
        ...
        public static SteamVR_Input_ActionSet_PriTaskController PriTaskController
        {
            get
            {
                return SteamVR_Actions.p_PriTaskController.GetCopy<SteamVR_Input_ActionSet_PriTaskController>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_PriTaskController = ((SteamVR_Input_ActionSet_PriTaskController)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_PriTaskController>("/actions/PriTaskController")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.PriTaskController};
        }
    }
}
