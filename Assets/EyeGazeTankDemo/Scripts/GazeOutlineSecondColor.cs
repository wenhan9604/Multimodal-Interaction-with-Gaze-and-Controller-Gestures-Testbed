...
namespace Tobii.XR.Examples
{
    ...
    public class GazeOutlineSecondColor : MonoBehaviour, IGazeFocusable
    {
        ...
        public float GazeOutlineAnimationTimeSeconds = 0.2f;
        ...
        {
            var color = _material.GetColor("_SecondOutlineColor");
            ...
            while (progress < 1.0f)
            {
                ...
                _material.SetColor("_SecondOutlineColor", color);
                yield return null;
            }
        }
    }
